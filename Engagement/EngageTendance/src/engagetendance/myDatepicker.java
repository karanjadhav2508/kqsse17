 ...
 * @author Sam
 * 
 * Much of the code in this class was inspired or taken directly from https://www.eduonix.com/blog/java-programming-2/how-to-use-date-picker-component-in-java/
 * This is for the use of the datepicker in Java, which was interesting attempting to find a method that worked..
 * 
 * 
 */
...
public class myDatepicker  {
    //define variables
        ...
        public myDatepicker(JFrame parent)  //create constructor 
        {
        	//create object
                d = new JDialog();
                //set modal true
                ...
                {		
                	//define variable
                        ...
                        if (x < 7)//if loop condition 
                        {
                                ...
                                button[x].setForeground(Color.DARK_GRAY);
                        }
...
class Picker 
{
        public static void main(String[] args) // main method
        {
        	...
        	b.addActionListener(new ActionListener() 
        	{
        		...
        		{
        			//set text i.e. date
        			text.setText(new myDatepicker(f).setPickedDate());
        		}
            });
        }
}
