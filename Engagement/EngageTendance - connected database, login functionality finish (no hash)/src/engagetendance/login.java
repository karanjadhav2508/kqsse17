...
public class login {
    ...
    public boolean verifyLogin(){
        String q = "Select users.userID,name,roleID,pass from users,password where users.userID=\"smscoggi\" and password.userID=\"smscoggi\"";
    ...
    private void ContinueLogin(String user,int role, String name){
        ...
        this.user = user;
                ...
                h.setAttributes(this.user, this.name, this.role);
